...
openings <- function() {
  ...
  abline(v = as.POSIXct("2020-03-13"), col = "orange")
 ...
 # Phase 1 opening
  ...
  # Phase 3 - surgical measures
    
    abline(v = as.POSIXct("2020-09-19"), col = "orange") # lowered limits of private gatherings
      abline(v = as.POSIXct("2020-09-25"), col = "orange") #tighter hours on bars and restaurants
...
plot(weekdays, ON_status$tests_last_day,
     ylab="Tests reported", xlab="Day of Report (by 3/4 pm)")
