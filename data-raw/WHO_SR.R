...
existing <- c("SituationReport","Date",
              ...
              "Belgium","UnitedArabEmirates","Egypt", "Iran",
              "Lebanon", "Israel", 
              ...
              "France.deaths", "RepublicofKorea.deaths", "Iran.deaths",
              "Italy.deaths",
              "InternationalConveyance.deaths",
...
new <- c("situation_report","date",
         ...
         "cases_bel","cases_are","cases_egy", "cases_irn", 
         "cases_lbn", "cases_isr",
         "cases_kwt", "cases_afg", "cases_bhr", "cases_irq", "cases_omn",
         "cases_internationconveyance",

         "cases_global","suspected_chn","severe_chn",
         "deaths_chn", "deaths_phl", "deaths_jpn",
         "deaths_fra", "deaths_kor", "deaths_irn", 
         "deaths_ita", 
